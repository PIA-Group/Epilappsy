...
class Humor {
  ...
  Humor(this._fields, this._answers);
...
Widget filledhumor(BuildContext context, humor_level) {
  IconData icon_humor;
  if (humor_level == 'Sad') {
    icon_humor = MyFlutterApp.cloudy;
  } else if (humor_level == 'Happy') {
    icon_humor = MyFlutterApp.sunny_day;
  } else {
    icon_humor = MyFlutterApp.storm;
  }
  return Card(
      elevation: 3,
