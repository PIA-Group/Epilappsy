              ...
              itemBuilder: (context, position) {
                return Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async { //TODO: NEW SEIZURE TYPE
                      ...
                      await BAApi.getJsonForm(
                        ...
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => BAAddSeizurePage(duration: duration, seizure: seizure, formFields: form, seizureName: snapshot.data[position]['title'])));
                      });
                    },
                  ),
                );
