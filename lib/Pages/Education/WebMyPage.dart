...
class WebMyPage extends StatefulWidget {
  final String url;
  final String question;

  ValueNotifier<List<RecordObject>> records;

  WebMyPage({Key key, this.records, this.question, @required this.url})
      : super(key: key);

  @override
  _WebMyPageState createState() => _WebMyPageState();
}

class _WebMyPageState extends State<WebMyPage> {
